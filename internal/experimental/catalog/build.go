...
import (
	...
	"github.com/joelanford/kpm/internal/experimental/bundle"
	"github.com/joelanford/kpm/internal/experimental/fsutil"
...
func writeCatalog(fbcFsys fs.FS, cacheFsys fs.FS, tagRef reference.NamedTagged, extraAnnotations map[string]string, outputDirectory string) (*BuildResult, error) {
	...
	// Write it!
	desc, err := kpm.WriteImageManifest(kpmFile, tagRef, layers, nil, annotations)
	if err != nil {
