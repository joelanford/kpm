...
func LoadRegistryV1(spec specsv1.RegistryV1, workingDir string) (builder.Builder, error) {
	b := &registryV1Builder{
	...
	case specsv1.RegistryV1SourceTypeBundleDirectory:
		b.root = os.DirFS(filepath.Join(workingDir, spec.Source.BundleDirectory.Path))
	default:
